...
console.log('require("react") is stable: ', React === require("react"));

// const util = require("util");
// console.log("markdown: React v8 address =", util.inspect(React, { showHidden: true, depth: 0 }));

globalThis.FirstReact = React;

const setOutput = (html) => {
  globalThis.output = html;
};
...
var import_deadsimpleseo_react = __toESM(require("deadsimpleseo-react"));
...
function App() {
  var useSEOPage = import_deadsimpleseo_react.useSEOPage;
  var useSEOPageComponent = import_deadsimpleseo_react.useSEOPageComponent;
